...
(
  foodbank_id UUID PRIMARY KEY NOT NULL,
...
(
  ...
  reservation_creation_date NOT NULL DEFAULT CURRENT_TIMESTAMP,
  user_uuid TEXT,
  pickupTime DATETIME,
  showedUP BOOLEAN,
  showedUPtime DATETIME,
  reservatrion_items JSONB[] NOT NULL,
  current_status TEXT,
)

CREATE TABLE IF NOT EXISTS donations (
    donation_id UUID PRIMARY KEY NOT NULL,
    donation_creation_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
